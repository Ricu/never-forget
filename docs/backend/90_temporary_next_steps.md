# Temporary Backend Next Steps

This is a temporary tracking note so the current backend work does not drift.
...
7. Build a barebones frontend.
8. Add minimal infrastructure, likely starting with Docker Compose.
